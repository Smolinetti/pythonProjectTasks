...
# Выведитте на экран саму последовательность
# и сумму элементов этой последовательности
...
for i in range(1, number+1):
    f = (1 + 1/i)**i
    fact.append(f)
print(f"Список из {number} чисел", fact)
print("Сумма чисел списка равна: ", sum(fact))
